...
static const char dmenufont[]       = "SourceCodeProMedium:size=12";
...
static const char *dmenucmd[] = { "dmenu_run", "-p", ">", "-m", dmenumon, "-fn", dmenufont, "-nb", col_statusbarBG, "-nf", col_dmenuFG, "-sb", col_statusbarMiddle, "-sf", col_statusbarFG, "-i" , "-c", "-l", "10",  NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F5,  spawn, SHCMD("reloadKeys")}, // map keys again  
